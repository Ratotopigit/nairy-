import type { WebinarAnswers } from "./webinar-questionnaire";
...
export function parseAvatarChatPayload(
  raw: unknown,
  previous: AvatarBlueprint | null,
  existingAnswers?: WebinarAnswers
): AvatarChatResponse {
  ...
  // Extract sections if present in reply text
