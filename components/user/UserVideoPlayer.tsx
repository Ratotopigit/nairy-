  ...
  return (
    <div className="min-h-screen w-full relative">
      <div className="relative z-10 flex min-h-[600px] w-full lg:min-h-[700px]">
        <div className="relative w-full lg:w-3/4 bg-secondary rounded-t-xl overflow-hidden">
          <video
            src={videoSrc}
          ...
          <div className="absolute bottom-6 left-6 flex gap-2">
            <button
              type="button"
              className="p-3 bg-card/20 rounded-full hover:bg-card/30 transition-colors"
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-card/80 border-t border-border px-6 py-3 flex flex-wrap gap-4">
        ...
        <aside className="relative lg:w-1/4 bg-card border-l border-border flex flex-col h-fit">
          <div className="border-b border-border px-4 py-3 flex gap-2">
            ...
            <button
              ...
              className="flex-1 py-2 px-3 rounded-t-lg font-medium bg-muted text-muted-foreground hover:bg-secondary transition-colors"
            >
          ...
          {sidePanelView === "chat-polls" && (
            <div className="flex-1 p-4 space-y-4">
              <h3 className="text-sm font-medium text-muted-foreground">Live Chat</h3>
              <div className="h-40 bg-muted rounded-xl overflow-y-auto p-3">
              ...
              <div className="border-t border-border pt-4">
                <div className="flex gap-2">
                  <input
                    type="text"
                    className="flex-1 bg-muted rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-ring/20"
                    placeholder="Type your message..."
                  />
                  <button
                    type="button"
                    className="bg-primary text-primary-foreground rounded-lg px-4 py-2 text-sm hover:opacity-90 transition-colors"
                  >
                    Send
                  </button>
                </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="flex gap-2">
                    <button
                      type="button"
                      className="flex-1 bg-muted rounded-lg py-2 text-sm hover:bg-secondary transition-colors"
                    >
                      Technical hurdles
                    </button>
                  </div>
              ...
              <form onSubmit={handleSubmitQualification} className="space-y-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-muted rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-ring/20"
                  >
                ...
                <div className="flex gap-3">
                  <button
                    type="submit"
                    className="flex-1 bg-primary text-primary-foreground rounded-lg py-2.5 font-medium hover:opacity-90 transition-colors"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => setSidePanelView("chat-polls")}
                    className="flex-1 bg-muted rounded-lg py-2.5 text-sm hover:bg-secondary transition-colors"
                  >
                    Cancel
                  </button>
                </div>
            ...
            <div className="flex-1 p-4 space-y-4">
              ...
              {routingResult === "checklist" && (
                <div>
                  ...
                  <div className="bg-muted rounded-lg p-4 border border-ochre">
              ...
              {routingResult === "nurture" && (
                <div>
                  <p className="text-accent font-medium">Keep nurturing.</p>
              ...
              <button
                type="button"
                onClick={() => setSidePanelView("chat-polls")}
                className="w-full bg-muted rounded-lg py-2.5 text-sm hover:bg-secondary transition-colors"
              >
                Back to Chat
              </button>
            </div>
          ...
          {sidePanelView === "chat-polls" && !playing && (
            <div className="flex-1 p-4 text-center">
              <Play className="w-12 h-12 mx-auto text-primary mb-3" />
